...
export function DialogPublish() {
  ...
  const shareOnX = () => {
    ...
    const X_TEXT = `Check out this public page I created with Hive! ${publicLink}`
  ...
  const handlePublish = async () => {
    ...
    try {
      // Update chat to public via API
      const response = await fetch("/api/toggle-chat-public", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ chatId, public: true }),
      })
